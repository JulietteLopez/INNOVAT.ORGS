...
--
-- Servidor: localhost
-- Tiempo de generación: 01-10-2022 a las 19:33:02
...
--
-- Volcado de datos para la tabla `base_imss`
--

INSERT INTO `base_imss` (`id_base`, `descripcion`, `calculo`) VALUES
(1, 'SBC', '0'),
(2, 'SBC vs UMAS', '0'),
(3, 'xxxyyyzzz', 'x');
...
CREATE TABLE `detalle_nomina` (
  ...
  `tot_per` int(11) DEFAULT NULL,
  `isr` int(11) DEFAULT NULL,
  `imss` int(11) DEFAULT NULL,
  `tot_ded` int(11) DEFAULT NULL,
  `salario_neto` int(11) DEFAULT NULL,
  `tot_grabado` varchar(20) DEFAULT NULL,
...
INSERT INTO `detalle_nomina` (`id_calnomina`, `Curp`, `salario_base`, `tot_per`, `isr`, `imss`, `tot_ded`, `salario_neto`, `tot_grabado`, `nombre`) VALUES
(2, 'gfffffffffffffffff', 13, 34, 43, 4, 4, 5, 'f4', '');
...
--
-- Estructura de tabla para la tabla `tabla_imss`
--

CREATE TABLE `tabla_imss` (
...
--
-- Volcado de datos para la tabla `tabla_imss`
--

INSERT INTO `tabla_imss` (`Id_Concepto`, `Descripcion`, `Porcentaje`, `id_base`) VALUES
(1, 'fe', 10, 1),
(2, 'fe', 5485, 2);
...
ALTER TABLE `detalle_nomina`
  ADD PRIMARY KEY (`id_calnomina`,`Curp`) USING BTREE;
...
ALTER TABLE `per_nomina`
  ADD PRIMARY KEY (`id_calnomina`,`Curp`,`Id_Percepcion`) USING BTREE,
  ADD KEY `IdPercepcion` (`Id_Percepcion`);
...
--
-- Indices de la tabla `tabla_imss`
--
ALTER TABLE `tabla_imss`
...
--
-- AUTO_INCREMENT de la tabla `ded_nomina`
--
ALTER TABLE `ded_nomina`
  MODIFY `id_calnomina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `percepcion`
  MODIFY `Id_Percepcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `per_nomina`
--
ALTER TABLE `per_nomina`
  MODIFY `id_calnomina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `tabla_imss`
--
ALTER TABLE `tabla_imss`
...
--
ALTER TABLE `ded_nomina`
  ADD CONSTRAINT `ded_nomina_ibfk_1` FOREIGN KEY (`id_calnomina`,`Curp`) REFERENCES `detalle_nomina` (`id_calnomina`, `Curp`),
...
--
ALTER TABLE `nomina`
  ADD CONSTRAINT `nomina_ibfk_1` FOREIGN KEY (`IdArea`) REFERENCES `area` (`idArea`),
  ADD CONSTRAINT `nomina_ibfk_2` FOREIGN KEY (`Idperiodo`) REFERENCES `periodo` (`idperiodo`),
  ADD CONSTRAINT `nomina_ibfk_3` FOREIGN KEY (`Id_nomina`) REFERENCES `tipo_nomina` (`id_nomina`);
...
--
ALTER TABLE `per_nomina`
  ADD CONSTRAINT `per_nomina_ibfk_1` FOREIGN KEY (`Id_Percepcion`) REFERENCES `percepcion` (`Id_Percepcion`);
COMMIT;
